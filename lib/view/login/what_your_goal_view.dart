...
class WhatYourGoalView extends StatefulWidget {
  ...
  const WhatYourGoalView({Key? key, this.onNext}) : super(key: key);
  ...
  final List goalList = [
    {
      ...
      'title': "Improve Shape",
      'subtitle': "Build strength and gain muscle with\nour expert guidance.",
    },
    {
      'image': "assets/img/goal_2.png",
      'title': "Lean & tone",
      'subtitle':
          "Boost your stamina and endurance with\nour tailored workouts.",
    },
    {
      'image': "assets/img/goal_3.png",
      'title': "lose a fat",
      'subtitle': "Get fit and lose weight with\nour personalized plans.",
    },
  ];
  @override
